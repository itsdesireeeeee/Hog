...
def swine_align(player_score, opponent_score):
    ...
    # BEGIN PROBLEM 4a
    "*** YOUR CODE HERE ***"
    potential_gcf = min(player_score, opponent_score)
    while potential_gcf >= 1:
        if player_score % potential_gcf == 0 and opponent_score % potential_gcf == 0:
            return potential_gcf >= 10
        potential_gcf = potential_gcf - 1
    return False
...
def play(strategy0, strategy1, score0=0, score1=0, dice=six_sided,
    ...
    while score0 < goal and score1 < goal:
        if who == 0:
            ...
            score0 = take_turn (num_rolls, score1, dice) + score0
            ...
            score1 = take_turn (num_rolls, score0, dice) + score1
            say = say(score0, score1)
...
def announce_highest(who, last_score=0, running_high=0):
    ...
    def say(score0, score1):
        ...
        return announce_highest(who, score, max(score - last_score, running_high))
    return say
    # END PROBLEM 7
...
def make_averaged(original_function, trials_count=1000):
    ...
    def new_func(*args):
        count_trials = 1
        x = 0
        while count_trials <= trials_count:
            x = original_function(*args) + x
            count_trials = count_trials + 1
        return x / trials_count 
    return new_func
...
def max_scoring_num_rolls(dice=six_sided, trials_count=1000):
    ...
    lowest_dice = 0
    while d > 0:
        pt_score = make_averaged(roll_dice, trials_count)(d, dice)
        if pt_score > old_pt_score:
            lowest_dice = d
            old_pt_score = pt_score
        d = d - 1
    return lowest_dice
...
def bacon_strategy(score, opponent_score, cutoff=8, num_rolls=6):
    ...
    if n >= cutoff:
        ...
        return num_rolls # Replace this statement (6 WAS HERE WHEN STARTED )
    # END PROBLEM 10
